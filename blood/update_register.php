...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_sql = "UPDATE register SET fullName='$fullName', email='$email', username='$username', password='$password', gender='$gender', bloodGroup='$bloodGroup' WHERE id='$id'";
...
<head>
    ...
    <title>Update Register Entry</title>
    <style>
       body {
